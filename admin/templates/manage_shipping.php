...
<head>
    ...
    <title>Quản lý hình thức giao hàng</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Quản lý hình thức giao hàng</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Hình thức giao hàng</h3>
                            <div class="row">
                                <p class="text-muted col-sm-9"><code>Tất cả hình thức giao hàng trong hệ thống</code></p>
                                <div class="col-md-3">
                                    <button id="create-btn" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Thêm</button>
                                    <button type="button" class="btn btn-secondary" onclick="window.location = '../handle/handle_shipping.php?export=shipping'">Xuất Excel</button>
                                </div>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tạo hình thức giao hàng mới</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="create-form">
                                <div class="mb-3">
                                    <label for="code" class="form-label">Mã hình thức giao hàng</label>
                                    <input type="text" class="form-control" id="code">
                                </div>
                                <div class="mb-3">
                                    <label for="name" class="form-label">Tên hình thức giao hàng</label>
